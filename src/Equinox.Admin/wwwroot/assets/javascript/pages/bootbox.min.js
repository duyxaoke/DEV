...
! function (a, b) {
    ...
    var n = {
        dialog: "<div class='modal fade bootbox modal' tabindex='-1' role='dialog' aria-labelledby='exampleModalLabel' aria-hidden='true'><div class='modal-dialog' role='document'><div class='modal-content'><div class='modal-header'><h5 class='modal-title'>Xác nhận</h5></div><div class='modal-body'><div class='bootbox-body'></div></div></div></div></div>",
